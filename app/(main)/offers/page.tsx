...
const FilterSidebar = () => (
  <div className="space-y-4 border rounded-lg overflow-hidden shadow-sm">
    ...
    <div className="bg-white p-4 border-b">
      ...
      <div className="w-[90%] h-[4px] bg-[#F27D31] mx-auto mb-2 rounded"></div>
      ...
      <div className="flex justify-between items-center">
        ...
        <button className="bg-[#F27D31] text-white px-3 py-1 rounded text-sm hover:bg-[#e56f28] transition">
          Apply
        </button>
      </div>
    </div>
    ...
    <div className="bg-white p-4 border-b">
      ...
      <div className="flex gap-2 mb-3 flex-col">
        <input
          ...
          className="border border-gray-300 rounded px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-[#F27D31]"
        />
        <button className="bg-[#F27D31] text-white px-3 py-1 rounded text-sm hover:bg-[#e56f28] transition">
          Search
        </button>
